import { Twitter, Linkedin, Github, BookOpen, Code2 } from 'lucide-react';
...
const socialLinks = [
  ...
  { label: 'LinkedIn', href: 'https://www.linkedin.com/in/nenad-mirkovic-27109138b', icon: Linkedin },
  { label: 'GitHub', href: 'https://github.com/VisionSF-ai', icon: Github },
];

const articleLinks = [
  {
    label: 'Medium',
    href: 'https://medium.com/@dadyfredy4/workshop-the-ai-tool-that-refuses-to-forget-9025d15e6840',
    icon: BookOpen,
    description: 'Workshop Methodology'
  },
  {
    label: 'Dev.to',
    href: 'https://dev.to/dady_fredy/workshop-the-ai-tool-that-refuses-to-forget-5b21',
    icon: Code2,
    description: 'Workshop Methodology'
  },
];
                  ...
                  return (
                    <li key={item.label}>
                      <a
                        ...
                        className="group flex items-center gap-2 text-sm text-gray-400 transition-colors duration-200 hover:text-white focus:outline-none focus-visible:text-white"
                      >
                        <Icon className="h-4 w-4 text-primary-400 group-hover:text-primary-300" aria-hidden="true" />
