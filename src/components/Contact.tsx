...
import { Mail, Calendar, Clock, Send, CheckCircle, Loader2 } from 'lucide-react';

export interface ContactProps {
  // Add props as needed
}

// Formspree form ID - https://formspree.io/f/xdaanvew
const FORMSPREE_ID = 'xdaanvew';

// Cal.com booking link
const CALCOM_LINK = 'https://cal.com/dady-fredy-zx3r0c/free-consultation';
            ...
            {isSubmitted ? (
              ...
              >
                ...
                <button
                  ...
                  className="w-full bg-accent-500 hover:bg-accent-600 disabled:bg-accent-400 disabled:cursor-not-allowed text-white font-semibold py-4 px-6 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
                >
                  {isSubmitting ? (
                    <>
